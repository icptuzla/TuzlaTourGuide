...
const TRANSLATIONS_RAW: Record<Language, TranslationSet> = {
  en: {
    ...
    connectSteps: "1. Click 'Select Wallet'\n2. Choose Solana wallet app\n3. Confirm in your app",
    safeUsage: 'Safe Usage',
    safeTips: '. Never share your phrase\n. Confirm every transaction\n. Use official Solana apps only',
    txHistory: 'Where is history?',
    historyLocation: 'Transaction history is saved within your connected wallet app (Solflare/Phantom).',
    ...
    connectedToSolana: 'Connected to Solana',
  },
  bs: {
    ...
    connectSteps: "1. Kliknite 'Select Wallet'\n2. Odaberite Solana aplikaciju\n3. Potvrdite u aplikaciji",
    safeUsage: 'Sigurno korištenje',
    safeTips: '. Nikad ne dijelite šifre\n. Potvrdite svaku transakciju\n. Koristite zvanične Solana aplikacije',
    txHistory: 'Gdje je historija?',
    historyLocation: 'Historija transakcija se čuva u vašoj povezanoj aplikaciji (Solflare/Phantom).',
    ...
    solanaWallet: 'Solana novčanik',
    tonWallet: 'TON novčanik',
    switchNetwork: 'Promijeni mrežu',
    connectedToSolana: 'Povezan na Solanu',
  },
  de: {
    ...
    connectSteps: "1. Klick auf 'Select Wallet'\n2. Wahl deine Solana Wallet App aus\n3. Bestatige alles in deiner App",
    safeUsage: 'Sicherheitstipps',
    safeTips: '. Teil niemals deine Recovery Phrase\n. Bestatige jede Transaktion einzeln\n. Nutze nur offizielle Solana Apps',
    txHistory: 'Wo ist der Verlauf?',
    historyLocation: 'Dein Transaktionsverlauf wird direkt in deiner Wallet App (Solflare/Phantom) gespeichert.',
    ...
    connectedToSolana: 'Mit Solana verbunden',
  },
  tr: {
    ...
    connectSteps: "1. 'Select Wallet'a tıklayın\n2. Solana cüzdanını seçin\n3. Uygulamada onaylayın",
    safeUsage: 'Güvenli Kullanım',
    safeTips: '. Şifrenizi asla paylaşmayın\n. Her işlemi onaylayın\n. Yalnızca resmi Solana uygulamalarını kullanın',
    txHistory: 'Geçmiş nerede?',
    historyLocation: 'İşlem geçmişi bağlı cüzdanınıza (Solflare/Phantom) kaydedilir.',
    ...
    connectedToSolana: 'Solanaya Bağlı',
  },
};
